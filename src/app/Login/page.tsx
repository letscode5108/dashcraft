...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    if (credentials.username === MOCK_USER.username && 
      ...
      // Redirect to dashboard - THIS IS THE KEY PART
      router.push('/dashboard');
    } else {
